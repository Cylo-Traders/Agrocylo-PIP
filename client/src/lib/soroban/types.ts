 ...
 * `contracts/escrow_types/src/lib.rs` (`pub enum CampaignStatus`). UI-only
 * derived states (a Funded campaign that has already released a tranche
 * presenting as "in production") live in `lib/campaignStatus.ts` and are not
